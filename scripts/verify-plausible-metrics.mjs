...
function main(argv, env) {
  ...
  // Fail before plausibility comparisons: an unpriced source model dropped from the rollup
  // shrinks the totals silently — a configuration defect, not a legitimate smaller harvest.
  assertSourceModelsAccountedFor(candidate);
  let served = null;
